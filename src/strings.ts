...
const strings = {
    welcome: 'WELCOME TO YOUR 10 MINUTE SELF-ASSESSMENT',
    appTitle: 'Burnout Coach',
    watchFirst: 'Watch this first BEFORE you complete the assessment',
    propagandaPart1:
        'Take my free 10 minute self-assessment to see the reasons you\'re feeling out of balance, what to focus on and how to fix it. When you submit your answers at the end, your Wheel will display and your answers will be emailed to you.',
    propagandaPart2:
